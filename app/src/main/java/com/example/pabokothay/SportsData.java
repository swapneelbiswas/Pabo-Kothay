...
public class SportsData {
    ...
    public SportsData(String shopdescribe, String shopName, String price, String image, String shopkeeperId, float rating) {
    ...
    public SportsData(String shopdescribe, String shopName, String price, String image) {
        this.shopdescribe = shopdescribe;
        this.shopName = shopName;
        this.price = price;
        this.image = image;
